...
brms_reg_weibull = function(df_sim, p, g, seed = 123) {
  ...
  for (i in 1:nrow(df_sim_test)) {
    ...
    cat("exp linpred scale", i, ":", scale_adj, ",", "shape and sale est:", shape_est, scale_est, "\n")
...
## Method: Weibull; p = 20; $n \in \{250, 500\}$; $r_{nz} \in \{ 1\}$ 
...
## Method: Weibull; p = 200; $n \in \{250, 500\}$; $r_{nz} \in \{1\}$ 
