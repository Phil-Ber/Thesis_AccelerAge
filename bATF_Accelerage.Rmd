...
run_experiment = function(pop_n = 20000, obs_n = 1000, p = 20, g = 4, ltname, bfrac, seed, nzb, bsep, X_rho) {
  ...
  df_sim = generate_data(pop_n = pop_n, obs_n = obs_n, p = p, g = g,
                       ...
                       active_hazard = 0, # (0.05*sqrt(p))/nzb/bfrac/bsep,
...
```{r}
# p = 20
rmses = run_experiment(p = 20, g = 4, ltname = "p20_may20", bfrac = 40, seed = 42, nzb = 0.75, bsep = 2, X_rho = 0)
print(rmses)

rmses = run_experiment(p = 60, g = 4, ltname = "p60_may20", bfrac = 40, seed = 43, nzb = 0.75, bsep = 2, X_rho = 0)
print(rmses)
# 
# rmses = run_experiment(p = 100, g = 4, ltname = "p100_may20", bfrac = 40, seed = 44, nzb = 0.5, bsep = 2, X_rho = 0)
# print(rmses)
# 
# rmses = run_experiment(p = 200, g = 4, ltname = "p200_may20", bfrac = 10, seed = 45, nzb = 0.5, bsep = 2, X_rho = 0)
# print(rmses)
```
