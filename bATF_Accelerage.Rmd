...
brms_reg_weibull = function(df_sim, p, g, seed = 123) {
  ...
  fit_bayes_aft = brm(
    ...
    control = list(adapt_delta = 0.97, max_treedepth = 12, stepsize = 0.1),
    seed = seed,
...
debug_methods(n = 400, p = 100, g = 5, method = "weibull", seed = 42, t_SNR = 2, perf_A = T, nzg = 1) %>%
  system.time()
```
