...
```{r}
results = run_grid_experiments_mc(n_grid = c(200), p_grid = c(10),
                                  g_grid = c(5), non_zero_grid = c(1), M = 2,
                                  target_snr = 4, pop_n = 100000, bsep = 4,
...
debug_methods(n = 400, p = 20, g = 5, method = "weibull", seed = 40, t_SNR = 2, perf_A = T, nzg = 1) %>%
  system.time()
```
